...
import {
  ...
  User, Users, Warehouse, BookOpen, Tag, BarChart2, Star, Settings,
} from 'lucide-react'
import { useAuth } from '@/modules/auth/context/auth-context'
import { cn } from '@/lib/utils'

const navItems = [
  { title: 'Dashboard',      url: '/app/productor/dashboard',     icon: LayoutDashboard },
  { title: 'Mi Perfil',      url: '/app/productor/perfil',        icon: User },
  { title: 'Publicaciones',  url: '/app/productor/publicaciones', icon: Package },
  { title: 'Inventario',     url: '/app/productor/inventario',    icon: Warehouse },
  { title: 'Leads',          url: '/app/productor/leads',         icon: Users },
  { title: 'Cotizaciones',   url: '/app/productor/cotizaciones',  icon: FileText },
  { title: 'Documentos',     url: '/app/productor/documentos',    icon: BookOpen },
  { title: 'Promociones',    url: '/app/productor/promociones',   icon: Tag },
  { title: 'Analítica',      url: '/app/productor/analitica',     icon: BarChart2 },
  { title: 'Reputación',     url: '/app/productor/reputacion',    icon: Star },
  { title: 'Configuración',  url: '/app/productor/configuracion', icon: Settings },
]
