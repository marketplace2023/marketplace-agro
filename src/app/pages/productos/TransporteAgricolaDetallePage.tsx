        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_288px]">
          <div className="flex flex-col gap-5">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-gray-100 shadow-sm">
              <img src="/farm-bg.png" alt="Camión refrigerado" className="h-64 w-full object-cover" />
              <div className="absolute inset-0 bg-linear-to-t from-black/40 to-transparent" />
              <div className="absolute left-3 top-3">
                <span className="rounded-full bg-sky-700/90 px-2.5 py-1 text-[11px] font-bold text-white backdrop-blur-sm">Transporte Refrigerado</span>
              </div>
              <div className="absolute bottom-3 left-3 flex items-center gap-2">
                <span className="rounded-full bg-white/90 px-2.5 py-1 text-[11px] font-bold text-gray-700 backdrop-blur-sm shadow-sm flex items-center gap-1">
                  <Truck className="h-3 w-3 text-sky-600" />Capacidad: 10 toneladas
                </span>
              </div>
            </div>
